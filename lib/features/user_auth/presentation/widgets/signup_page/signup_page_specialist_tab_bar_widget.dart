...
class SignupPageSpecialistTabBar extends StatefulWidget {
  final bool isFirstPage;
  final String path;

  const   SignupPageSpecialistTabBar({
    super.key,
  ...
  @override
  State<SignupPageSpecialistTabBar> createState() => _SignupPageSpecialistTabBarState();
}

class _SignupPageSpecialistTabBarState extends State<SignupPageSpecialistTabBar> {
